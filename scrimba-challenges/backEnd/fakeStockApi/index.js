...
function renderStockTicker(stockData) {   
    ...
    stockDisplayPrice.textContent = currPrice
    stockDisplayTime.textContent = stockData.time    
    
    stockDisplayPriceIcon.classList.remove('stock-up')
    stockDisplayPriceIcon.classList.remove('stock-down')    
    stockDisplayPriceIcon.classList.remove('stock-equal')
    
    if(prevPrice==currPrice){
      
      stockDisplayPriceIcon.classList.add('stock-equal')
    }else if(prevPrice<currPrice){
      stockDisplayPriceIcon.classList.add('stock-up')
    }else{
      stockDisplayPriceIcon.classList.add('stock-down')
    }
